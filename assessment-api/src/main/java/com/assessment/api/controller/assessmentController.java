...
public class assessmentController {
	...
	public ResponseEntity<Object> getQuestionsOfAssessment(@PathVariable String assessmentId) {
		try {			
			return ResponseHandler.generateResponse("success", HttpStatus.OK, assessmentService.getAssessmentById(UUID.fromString(assessmentId)).getQuestions());
		} catch (Exception ex) {
